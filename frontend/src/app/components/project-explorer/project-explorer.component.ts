...
@Component({
    ...
    imports: [MatTreeModule, MatIconModule, MatButtonModule, MatFormFieldModule, MatInputModule, MatMenuModule, CdkDrag, CdkDropList, Menubar],
...
export class ProjectExplorerComponent {
    ...
    menuItems: MenuItem[] = [
        ...
        },
        {
            ...
            icon: 'pi pi-add',
            items: [
                {label: 'Schema', icon: 'pi pi-sitemap', command: () => this.addFileToRoot('schema', 'diagram')},
                {label: 'Helper', icon: 'pi pi-code', command: () => this.addFileToRoot('helper', 'java')},
                {label: 'New Directory', icon: 'pi pi-folder-plus', command: () => this.addFolderToRoot('directory')}
            ]
        },
        {
            label: 'Import',
            icon: 'pi pi-sign-in',
            items: [
                {label: 'Import Project', icon: 'pi pi-book', command: this.importProject},
                {label: 'Import File', icon: 'pi pi-file-import', command: this.import}
            ]
        },
        {
            label: 'Export',
