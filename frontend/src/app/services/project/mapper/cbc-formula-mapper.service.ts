...
import {IAbstractStatement, AbstractStatement} from '../../../types/statements/abstract-statement';
import {IPosition, Position} from '../../../types/position';
import {ISkipStatement, SkipStatement} from '../../../types/statements/strong-weak-statement';
...
import {IStatement, Statement} from "../../../types/statements/simple-statement";
...
export class CbcFormulaMapperService {
    ...
    private importStatement(statement: IAbstractStatement | undefined): AbstractStatement | undefined {
        if (!statement) {
            return
        }
        ...
        switch (statement.type) {
            ...
            case RepetitionStatement.TYPE:
                return this.importRepetitionStatement(statement as IRepetitionStatement)
            case CompositionStatement.TYPE:
                return this.importCompositionStatement(statement as ICompositionStatement)
    ...
    private importSelectionStatement(statement: ISelectionStatement): SelectionStatement {
    ...
    private importRepetitionStatement(statement: IRepetitionStatement): RepetitionStatement {
    ...
    private importCompositionStatement(statement: ICompositionStatement): CompositionStatement {
    ...
    private importGlobalConditions(conditions: ICondition[] | null): ICondition[] {
